...
! Programa en serie amb el modul d'integracio en paralel 
! utilitzat com a test per tal de comprobar la seva correcta implementacio
! 
! Fet per Pablo M. Blanco, Universitat de Barcelona
